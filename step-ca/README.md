...
- [cli](https://github.com/smallstep/cli/releases/download/v0.30.4/step_linux_0.30.4_amd64.tar.gz) `cli`
- [cosign](https://github.com/sigstore/cosign/releases/download/v3.1.1/cosign-linux-amd64) `cosign`
