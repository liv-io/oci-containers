...
- [plugin-git](https://github.com/woodpecker-ci/plugin-git/releases/download/3.1.0/linux-amd64_plugin-git) `3.1.0`
- [woodpecker-agent](https://github.com/woodpecker-ci/woodpecker/releases/download/v2.6.1/woodpecker-agent_linux_arm64.tar.gz) `2.6.1`
