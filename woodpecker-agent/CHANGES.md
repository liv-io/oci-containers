...
- Update woodpecker-agent to version 3.18.1
- Update plugin-git to version 2.10.1

## 3.18.0-1 (2026-08-24)

### Features

- Update woodpecker-agent to version 3.18.0
...
- Update plugin-git to version 2.9.3
...
- Update woodpecker-agent to version 3.16.0

## 3.15.0-1 (2026-05-28)

### Enhancements

- Update plugin-git to version 2.9.2

### Features

- Update woodpecker-agent to version 3.15.0

## 3.14.1-2 (2026-05-16)

### Bugs

- Update plugin-git to version 2.9.1

## 3.14.1-1 (2026-05-12)

### Bugs

- Update woodpecker-agent to version 3.14.1

## 3.14.0-1 (2026-05-01)

### Features

- Update woodpecker-agent to version 3.14.0

## 3.13.0-3 (2026-04-23)

### Enhancements

- Update plugin-git to version 2.9.0

## 3.13.0-2 (2026-01-25)

### Enhancements

- Update plugin-git to version 2.8.1

## 3.13.0-1 (2026-01-14)

### Features

- Update woodpecker-agent to version 3.13.0

## 3.12.0-2 (2026-01-10)

### Enhancements

- Update plugin-git to version 2.8.0

## 3.12.0-1 (2025-11-28)

### Features

- Update woodpecker-agent to version 3.12.0

## 3.11.0-1 (2025-10-20)

### Features

- Update woodpecker-agent to version 3.11.0

## 3.10.0-1 (2025-10-03)

### Enhancements

- Update plugin-git to version 2.7.0

### Features

- Update woodpecker-agent to version 3.10.0

## 3.9.0-1 (2025-08-24)

### Features

- Update woodpecker-agent to version 3.9.0

## 3.8.0-1 (2025-07-19)

### Features

- Update woodpecker-agent to version 3.8.0

## 3.7.0-1 (2025-06-07)

### Features

- Update woodpecker-agent to version 3.7.0

## 3.6.0-2 (2025-06-02)

### Bugs

- Update plugin-git to version 2.6.5
